...
BASE_OUT_DIR=${BASE_OUT_DIR:-outputs/culane_s0_structured_query_res34_b16_50ep/failure_diagnostics_val_175k/visual_hypothesis_bank}
FEATURE_CACHE=${FEATURE_CACHE:-${BASE_OUT_DIR}/visual_bank_features.pt}
...
for SPLIT_SEED in ${SPLIT_SEEDS}; do
  echo "visual hypothesis-bank sequence split seed: ${SPLIT_SEED}"
...
for SUMMARY_FEATURE in visual_bank visual_bank_geometry; do
