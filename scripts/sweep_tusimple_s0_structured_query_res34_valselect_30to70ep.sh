...
OUTPUT_DIR="${OUTPUT_DIR:-outputs/tusimple_s0_structured_query_res34_valselect_slots32_b8x2_1600x640_bins800_fpn256_l4_dfl_70ep}"
RESULT_DIR="${RESULT_DIR:-outputs/tusimple_val_sweeps/res34_30to70ep}"
...
CHECKPOINTS=(
  "${OUTPUT_DIR}/iter_0006135.pt"
  "${OUTPUT_DIR}/iter_0008180.pt"
  "${OUTPUT_DIR}/iter_0010225.pt"
  "${OUTPUT_DIR}/iter_0012270.pt"
  "${OUTPUT_DIR}/iter_0014315.pt"
)
