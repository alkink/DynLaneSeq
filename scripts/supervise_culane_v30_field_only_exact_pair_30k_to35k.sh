...
export OUTPUT_ROOT="/workspace/DynLaneSeq_v30_joint_field/outputs/diagnostics/v30_field_only_exact_pair_30k_to35k"

exec bash scripts/run_culane_v30_field_only_exact_pair_30k_to35k.sh
