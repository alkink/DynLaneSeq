...
FEATURE_SOURCE="${FEATURE_SOURCE:-p2}"
OUTPUT_ROOT="${OUTPUT_ROOT:-/home/alki/projects/DynLaneSeq/outputs/diagnostics/independent_p2_curve_proposals}"
OUTPUT_JSON="${OUTPUT_JSON:-${OUTPUT_ROOT}/dla34_225k_${FEATURE_SOURCE}_uniform64.json}"
SAVE_PROBE="${SAVE_PROBE:-${OUTPUT_ROOT}/dla34_225k_${FEATURE_SOURCE}_probe.pt}"
