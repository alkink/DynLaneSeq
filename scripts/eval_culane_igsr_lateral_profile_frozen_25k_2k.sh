...
CONFIG="dynlaneseq_eg/configs/culane_igsr_lateral_profile_frozen_25k.yaml"
OUT_DIR="outputs/culane_igsr_lateral_profile_frozen_25k"
...
"${PYTHON_BIN}" -u -m dynlaneseq_eg.tools.analyze_active_corridor_evidence \
  ...
  --output-json "outputs/active_corridor_diagnostics/lateral_profile_fulltrain_${ckpt_label}.json"
