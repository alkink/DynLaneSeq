...
CONFIG="${CONFIG:-dynlaneseq_eg/configs/culane_s0_structured_query_dla34_slots32_b8x2_1600x640_bins800_fpn256_l4_dfl_lane_balanced_finetune.yaml}"
RESUME="${RESUME:-outputs/culane_s0_structured_query_dla34_slots32_b8x2_1600x640_bins800_fpn256_l4_dfl_50ep/iter_0225000.pt}"
OUT_DIR="${OUT_DIR:-outputs/diagnostics/culane_dla34_225k_lane_balanced_finetune}"
...
echo "diagnostic: lane-balanced point/DFL fine-tune"
echo "resume: $RESUME"
