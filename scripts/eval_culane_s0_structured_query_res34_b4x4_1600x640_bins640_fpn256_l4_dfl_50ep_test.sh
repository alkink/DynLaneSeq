...
CKPT="${CKPT:-outputs/culane_s0_structured_query_res34_b4x4_1600x640_bins640_fpn256_l4_dfl_50ep/iter_0050000.pt}"
DEVICE="${DEVICE:-cuda}"
...
PRED_DIR="${PRED_DIR:-outputs/culane_s0_structured_query_res34_b4x4_1600x640_bins640_fpn256_l4_dfl_50ep/test_eval_${CKPT_TAG}_thr${SCORE_TAG}_q${QUALITY_TAG}_nms${NMS_TAG}}"
