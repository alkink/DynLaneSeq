...
CONFIG="${CONFIG:-dynlaneseq_eg/configs/debug/culane_s3_active_corridor_qualitycal_dynevidence_2k.yaml}"
OUT_DIR="${OUT_DIR:-outputs/debug_s3_active_corridor_qualitycal_dynevidence_2k}"
DEVICE="${DEVICE:-cuda}"
