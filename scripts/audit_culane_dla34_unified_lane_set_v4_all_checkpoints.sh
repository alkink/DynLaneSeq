...
CHECKPOINT_DIR="${CHECKPOINT_DIR:-outputs/culane_s0_structured_query_dla34_unified_lane_set_v4_bounded_delta_278k}"
...
RESULT_DIR="${RESULT_DIR:-outputs/diagnostics/unified_lane_set_v4_checkpoint_trajectory}"
...
echo "Unified lane-set V4 checkpoint trajectory completed."
