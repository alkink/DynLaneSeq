...
"${PYTHON}" - "${COVERAGE}" "${FULL_VAL}" "${OUTPUT_ROOT}/v30_summary.json" <<'PY'
import json, sys
...
summary = {
    "experiment": "V30 joint slot field, historical V7-35K comparison",
    "endpoint_iteration": 35000,
    "historical_v7_35k": {"f1_050": 0.7819890657, "f1_075": 0.5514466491},
