...
CONFIG="${CONFIG:-dynlaneseq_eg/configs/culane_s0_structured_query_res34_slots32_b8x2_1600x640_bins800_fpn256_l4_dfl_msrow_static_50ep.yaml}"
CKPT="${CKPT:-outputs/culane_s0_structured_query_res34_slots32_b8x2_1600x640_bins800_fpn256_l4_dfl_msrow_static_50ep/iter_0025000.pt}"
DEVICE="${DEVICE:-cuda}"
...
PRED_DIR="${PRED_DIR:-${PRED_ROOT}/val_eval_${CKPT_TAG}_thr${SCORE_TAG}_q${QUALITY_TAG}_nms${NMS_TAG}}"
