...
DEVICE="${DEVICE:-cuda}"
CKPT="${CKPT:-outputs/debug_s3_qualitycal_noexist_lineiou_2k/last.pt}"
SCORE_THRESH="${SCORE_THRESH:-0.55}"
QUALITY_POWER="${QUALITY_POWER:-0.5}"
PRED_DIR="${PRED_DIR:-outputs/debug_s3_qualitycal_noexist_lineiou_2k/culane_pred_val_thr${SCORE_THRESH}_q${QUALITY_POWER}}"
