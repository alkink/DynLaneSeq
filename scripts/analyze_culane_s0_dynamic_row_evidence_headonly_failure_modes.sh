...
CONFIG="${CONFIG:-dynlaneseq_eg/configs/culane_s0_dynamic_row_evidence_headonly_25k.yaml}"
CKPT="${CKPT:-outputs/culane_s0_dynamic_row_evidence_headonly_25k/iter_0002500.pt}"
SPLIT="${SPLIT:-val}"
EVAL_LIST="${EVAL_LIST:-dataset/list/val.txt}"
DEVICE="${DEVICE:-cuda}"
CACHE_DIR="${CACHE_DIR:-outputs/diagnostic_cache}"
OUT_DIR="${OUT_DIR:-outputs/culane_s0_dynamic_row_evidence_headonly_25k/failure_diagnostics_val}"
