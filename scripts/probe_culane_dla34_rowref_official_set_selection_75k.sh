...
TRAIN_CACHE="${TRAIN_CACHE:-outputs/diagnostics/cache/dla34_rowref_object0p5_75k_official_selection_train4096.pt}"
VAL_CACHE="${VAL_CACHE:-outputs/diagnostics/cache/dla34_rowref_object0p5_75k_official_selection_val256.pt}"
...
OUTPUT_JSON="${OUTPUT_JSON:-outputs/diagnostics/dla34_rowref_object0p5_official_set_selection_75k_uniform256.json}"
SAVE_PROBE="${SAVE_PROBE:-outputs/diagnostics/dla34_rowref_object0p5_official_set_selection_75k.pt}"
...
echo
echo "75k official set-selection report: $OUTPUT_JSON"
