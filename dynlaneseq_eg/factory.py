...
def build_criterion(cfg: dict[str, Any]) -> torch.nn.Module:
    ...
    base_kwargs = dict(
        ...
        w_four_slot_v15=float(loss.get("w_four_slot_v15", 0.0)),
        four_slot_v15_visual_weight=float(
            loss.get("four_slot_v15_visual_weight", 1.0)
        ),
        four_slot_v15_point_weight=float(
            loss.get("four_slot_v15_point_weight", 5.0)
        ),
        four_slot_v15_range_weight=float(
            loss.get("four_slot_v15_range_weight", 1.0)
        ),
        four_slot_v15_line_iou_weight=float(
            loss.get("four_slot_v15_line_iou_weight", 2.0)
        ),
        four_slot_v15_dfl_weight=float(
            loss.get("four_slot_v15_dfl_weight", 1.0)
        ),
        w_four_slot_v16=float(loss.get("w_four_slot_v16", 0.0)),
        four_slot_v16_quality_weight=float(
            loss.get("four_slot_v16_quality_weight", 1.0)
        ),
        four_slot_v16_pairwise_weight=float(
            loss.get("four_slot_v16_pairwise_weight", 1.0)
        ),
        four_slot_v16_hard_weight=float(
            loss.get("four_slot_v16_hard_weight", 1.0)
        ),
        four_slot_v16_representable_min=float(
            loss.get("four_slot_v16_representable_min", 0.50)
        ),
        four_slot_v16_pair_margin=float(
            loss.get("four_slot_v16_pair_margin", 0.02)
        ),
        ...
        w_four_slot_v19=float(loss.get("w_four_slot_v19", 0.0)),
        four_slot_v19_p50_weight=float(
            loss.get("four_slot_v19_p50_weight", 1.0)
        ),
        four_slot_v19_p75_weight=float(
            loss.get("four_slot_v19_p75_weight", 0.5)
        ),
        four_slot_v19_iou_weight=float(
            loss.get("four_slot_v19_iou_weight", 1.0)
        ),
        four_slot_v19_rank_weight=float(
            loss.get("four_slot_v19_rank_weight", 1.0)
        ),
        four_slot_v19_rank_temperature=float(
            loss.get("four_slot_v19_rank_temperature", 0.10)
        ),
        four_slot_v19_rank_min_gap=float(
            loss.get("four_slot_v19_rank_min_gap", 0.02)
        ),
