...
STRUCTURED_CONFIG = ROOT / "dynlaneseq_eg/configs/curvelanes_s0_structured_query_res34_slots32_b8x2_1600x640_bins800_fpn256_l4_dfl_50ep.yaml"
UNSTRUCTURED_CONFIG = ROOT / "dynlaneseq_eg/configs/curvelanes_s0_unstructured_query_res34_slots32_b8x2_1600x640_bins800_fpn256_l4_dfl_50ep.yaml"
...
def test_curvelanes_unstructured_is_a_matched_representation_ablation() -> None:
    ...
    assert structured["training"]["max_iters"] == 312500
    assert structured["training"]["seed"] == 3407
    assert _without_intended_differences(structured) == _without_intended_differences(unstructured)


def test_curvelanes_unstructured_builds_the_holistic_decoder() -> None:
